...
export const addPatient = async (req, res, next) => {
    try {
        const { name, diseases, allergies, room_number, bed_number, floor_number, age, gender, contact_info, emergency_contact, diet_chart_data, staff_id } = req.body;
